...
export class Home extends React.Component<RouteComponentProps<{}>, {}> {
    ...
    public render() {
        return <div>
            ...
            <h4><a href="//twitter.com/dustinsoftware">Twitter</a> &middot; <a href="https://github.com/dustinsoftware">Github</a>&middot; <a href="https://stackoverflow.com/cv/dustinmasters">Careers</a></h4>
